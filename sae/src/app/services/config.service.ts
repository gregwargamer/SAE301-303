...
export class ConfigService {
  // 🔴 IMPORTANT : Change cette URL par ton URL InfinityFree une fois hébergé
  // Exemple : readonly apiBase = 'https://ton-site.infinityfreeapp.com/api';
  ...
  //readonly apiBase = 'http://localhost/sushi/SAE301-303/sushi_box/api';  // Local
  readonly apiBase = 'https://eishi.free.nf/api';                          // Production
